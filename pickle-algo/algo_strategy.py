...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def on_turn(self, turn_state):
        ...
        # Put as absolute path
        dest = os.path.dirname(os.path.abspath(__file__)) + '/game_results/'
        # dest = '../pickle-algo/game_results/'

        # Don't spam files
        if game_state.turn_number == 0:
            with open((dest+ 'turn' + str(game_state.turn_number) + '.pickle'), 'wb') as f:
