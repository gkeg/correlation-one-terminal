...
class AlgoCore(object):
    ...
    def on_initial_action(self, game_state_str):
        pass
        ...
        while True:
            ...
            if "replaySave" in game_state_string:
                ...
                if stateType == 0:
                    ...
                    if start:
                        start = False
                        self.on_initial_action(json.loads(game_state_string))
                        # debug_write("========> " , state['events']['spawn'])
                        # debug_write("========> ", 'enemy spanwd ', str(emp_spawn), 'emps: ')
                continue
            elif stateType == 2:
                """
